        ...
        <table class="table-basic">
            ...
            <tr>
                ...
                <td class="actions-cell">
                    ...
                    <a class="btn-icon btn-danger" href="index.php?page=orders&action=delete&id=<?= e($o['order_id']) ?>" onclick="return confirm('Delete this order?')"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
